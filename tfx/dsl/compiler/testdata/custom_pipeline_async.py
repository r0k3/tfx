...
class CustomProducer(base_component.BaseComponent):
  ...
  def __init__(self, stats: types.Channel = None):
    ...
    stats.additional_properties['span'] = metadata_store_pb2.Value(int_value=42)
    stats.additional_properties['split_names'] = metadata_store_pb2.Value(
        string_value='[\'train\', \'eval\']')
    stats.additional_custom_properties['bar'] = metadata_store_pb2.Value(
        double_value=0.5)
